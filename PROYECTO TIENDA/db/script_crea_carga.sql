...
CREATE TABLE pedidos(
    ...
    estado ENUM('pagado', 'enviado', 'cancelado', 'archivado') NOT NULL,
...
INSERT INTO `usuarios` (`email`, `password`, `rol`, `nombre`) VALUES
    ('pepe@gmail.com', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', '1', 'Pepe');

INSERT INTO `clientes` (`nombre`, `apellidos`, `genero`, `direccion`, `codpostal`, `poblacion`, `provincia`, `password`, `email`) VALUES
    ('Pepe', 'García López', 'H', 'Calle Mayor 15', '28001', 'Madrid', 'Madrid', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'pepegarcilop@gmail.com'),
    ('María', 'Rodríguez Pérez', 'M', 'Avenida de la Constitución 4', '41001', 'Sevilla', 'Sevilla', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'm.rodriguez@gmail.com'),
    ('Carlos', 'Sánchez Ruiz', 'H', 'Calle Nueva 22', '08002', 'Barcelona', 'Barcelona', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'csanchez88@gmail.com'),
    ('Ana', 'Martínez Fernández', 'M', 'Plaza de España 10', '50001', 'Zaragoza', 'Zaragoza', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'ana.mtnez@gmail.com'),
    ('Javier', 'Gómez Jiménez', 'H', 'Calle Real 45', '46001', 'Valencia', 'Valencia', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'javier_gomez@gmail.com'),
    ('Laura', 'Díaz Moreno', 'M', 'Calle Ancha 7', '11001', 'Cádiz', 'Cádiz', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'laura.diaz@gmail.com'),
    ('Diego', 'Álvarez Vázquez', 'H', 'Calle de la Paz 12', '36201', 'Vigo', 'Pontevedra', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'diego_alv@gmail.com'),
    ('Elena', 'Romero Santos', 'H', 'Paseo del Prado 2', '28014', 'Madrid', 'Madrid', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'elena.romero@gmail.com'),
    ('Pablo', 'Torres Castro', 'H', 'Calle Victoria 9', '29001', 'Málaga', 'Málaga', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'ptorres92@gmail.com'),
    ('Sofía', 'Navarro Ortiz', 'M', 'Calle San Pablo 31', '37001', 'Salamanca', 'Salamanca', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'sofia_navarro@gmail.com'),
    ('Miguel', 'Gil Marín', 'H', 'Calle Estación 5', '47001', 'Valladolid', 'Valladolid', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'miguelgil@gmail.com'),
    ('Lucía', 'Blanco Morales', 'M', 'Calle Larga 18', '11401', 'Jerez de la Frontera', 'Cádiz', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'lucia.blanco@gmail.com'),
    ('Rubén', 'Serrano Muñoz', 'H', 'Calle Jardín 3', '30001', 'Murcia', 'Murcia', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'rserrano77@gmail.com'),
    ('Sara', 'Molina Delgado', 'M', 'Calle Luna 14', '03001', 'Alicante', 'Alicante', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'sara_molina@gmail.com'),
    ('Hugo', 'Ramos Ortega', 'H', 'Calle Sol 22', '18001', 'Granada', 'Granada', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'hugo.ramos@gmail.com'),
    ('Paula', 'Suárez Ibáñez', 'M', 'Calle Herrería 8', '01001', 'Vitoria', 'Álava', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'paula.suarez@gmail.com'),
    ('Jorge', 'Cano Rubio', 'H', 'Avenida del Sur 101', '06001', 'Badajoz', 'Badajoz', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'jorge.cano@gmail.com'),
    ('Marta', 'Heredia Ferrer', 'M', 'Calle del Río 55', '14001', 'Córdoba', 'Córdoba', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'marta_h@gmail.com'),
    ('Adrián', 'Crespo Prieto', 'H', 'Calle Pintor 4', '33001', 'Oviedo', 'Asturias', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'adrian_crespo@gmail.com'),
    ('Irene', 'Vega Esteban', 'M', 'Calle Mayor 80', '24001', 'León', 'León', '$2y$10$cmf/oS2/jYLIAT5ST90bROSn9aPRuNCMeY9ZaV.kie9Runf0lGmdy', 'irene.vega@gmail.com');
